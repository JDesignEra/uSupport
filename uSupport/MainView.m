...
- (void)viewDidLoad {
    ...
    [self animateButton:_btnAED Animation:@"slideLeft" Delay:0.7 Duration:1 Damping:0.7 Velocity:0.7 Force:1 Hide:NO];
    [self animateButton:_btnFE Animation:@"slideRight" Delay:0.7 Duration:1 Damping:0.7 Velocity:0.7 Force:1 Hide:NO];
    [self animateButton:_btnEall Animation:@"zoomIn" Delay:0.5 Duration:1 Damping:0.7 Velocity:0.7 Force:1 Hide:NO];
    [self animateButton:_btnECall Animation:@"slideUp" Delay:0.5 Duration:1 Damping:0.7 Velocity:0.7 Force:1 Hide:NO];
    [self animateImageView:_logo Animation:@"zoomIn" Delay:0.2 Duration:1 Damping:0.7 Velocity:0.7 Force:1 Hide:NO];
}
